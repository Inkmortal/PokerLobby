...
export const PreflopSolver: React.FC = () => {
  const catppuccin = {
    base: '#1e1e2e',
    mantle: '#181825',
    surface0: '#313244',
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{
            ...
            Master preflop ranges with GTO solutions
          </p>
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Icon name="preflop" size={40} color={catppuccin.base} />
          </div>
          ...
          <p style={{
            ...
            Preflop solving capabilities will be added in a future update
            to complete your poker training toolkit.
          </p>
          ...
          <div style={{
            ...
            {[
              { icon: 'positions', title: 'All Positions', desc: '6-max and 9-max tables' },
              { icon: 'stack', title: 'Stack Depths', desc: 'From 10BB to 200BB+' },
              { icon: 'ranges', title: 'Range Charts', desc: 'Visual opening ranges' }
            ].map((feature, i) => (
              <div key={i} style={{
                padding: '1.5rem',
